                    ...
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="getData"> 分析方法<br>
                            <p class="mx-auto mb-4">
                                        ...
                                        </p> From:<input type="date" name="startDate" v-model="form.startDate"> To:<input type="date" name="endDate" v-model="form.endDate">
                            ...
                            <p><button type="" class="mt-4 flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">分析する</button></p>
                        </form>
