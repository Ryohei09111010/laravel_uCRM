                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <section class="text-gray-600 body-font relative">
                            <form @submit.prevent="storeCustomer" action="" method="post" novalidate>
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <p><label class="leading-7 text-sm text-gray-600">性別</label></p>
                                                    <input id="gender0" type="radio" name="gender" v-model="form.gender" value="0">
                                                    <label for="gender0" class="ml-2 mr-4">男性</label>
                                                    <input id="gender1" type="radio" name="gender" v-model="form.gender" value="1">
                                                    <label for="gender1" class="ml-2 mr-4">女性</label>
                                                    <input id="gender2" type="radio" name="gender" v-model="form.gender" value="2">
