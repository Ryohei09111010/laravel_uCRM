...
// Computedを使用すると中のtem.priceなどが変更されたことを検知して処理を再度実行する
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <section class="text-gray-600 body-font relative">
                            <form @submit.prevent="storePurchase" action="" method="post" novalidate>
                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <Micromodal />
                                                <div class="relative">
                                                    <label for="customer" clacustomer="leading-7 text-sm text-gray-600">会員名</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="number" id="price" price="name" v-model="form.price" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
