                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font relative">
                            <form @submit.prevent="updatePurchase(form.id)" action="" method="post" novalidate>
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="status" clastatus="leading-7 text-sm text-gray-600">ステータス</label>
                                                    <div class="ml-8 mt-1">
                                                        <input type="radio" id="status" v-model="form.status" name="status" value="1" class="ml-8">未キャンセル
